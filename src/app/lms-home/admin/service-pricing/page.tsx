...
import { useNodePaths } from "@/hooks/use-node-paths";
...
export default function ServicePricingPage() {
  ...
  // doesn't use those levels - so the row shows the item's full path instead
  // (a bare name is ambiguous when two items share it).
